<?php
 ...
 $sql = "INSERT INTO `absence` ( `id`, `date-debut`, `date-fin`,  `type-congé`, `Etat`, `username`) VALUES  ('$id','$datedebut','$datefin','$type1','$Etat','$login_session')";
 ...
 $sql4 = "INSERT INTO `intérime` (`id`, `nbr-intérime`, `matricule1`, `date-debut1`, `date-fin1`, `matricule2`, `debut2`, `fin2`) VALUES ('$ref1', '$nbrintérime', '$Matricule1', '$datedebut1', '$datefin1', '$Matricule2', '$debut2', '$fin2')";
 $sql2 = "INSERT INTO `titre-conge` (`id`, `ref`, `type`, `signataire`, `adresse`, `signature`, `date-debut`, `date-fin`, `Matricule`) VALUES ('$id', '$ref', '$type', '$signataire', '$adresse', '$signature', '$datedebut', '$datefin', '$Matricule')";
...
echo " date de debut est supérieur à date fin";
